...
#     # if sum(row == 1 for row in current_state) == 1 and all(row in {0, 1} for row in current_state): #And if K (Sticks = 1 and one row)
...
#     # elif sum(row == 1 for row in current_state) == 1 and all(row in {0, 1} for row in current_state): #And if K (Sticks = 1 and one row)
#     #     return True
